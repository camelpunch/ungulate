...
Note that Ungulate::FileUpload has now been superseded by [https://github.com/amazonwebservices/aws-sdk-for-ruby/blob/master/lib/aws/s3/presigned_post.rb](the official Amazon SDK version)
